...
public class LinkedListTest {
  ...
  public void testInsert() {
    ...
    assertEquals("The value should be hello ", "hello", insert.head.value);
  }
...
//}
  ...
  @Test
  public void testMulInsert() {
    LinkedList multInsert = new LinkedList("hello");
    multInsert.insert("hi");
    multInsert.insert("nice");
    assertEquals("The result should be nice", "nice", multInsert.head.value);
  }

  @Test
  public void testInculdes() {
  ...
  public void testInsertBefMid() {
    ...
    assertEquals("the result should be {head}->{2}->{9}->{3}->{5}->{8}->NULL", "{head}->{2}->{9}->{3}->{5}->{8}->NULL", returnList.tostring());
  }
